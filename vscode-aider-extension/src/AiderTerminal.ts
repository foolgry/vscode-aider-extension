...
export class AiderTerminal implements AiderInterface {
    ...
    constructor(openaiAPIKey: string | null | undefined, aiderCommand: string, onDidCloseTerminal: () => void, workingDirectory: string, model: string) {
        ...
        this._terminal.show();
        this._terminal.sendText(`${aiderCommand} --model ${model}`);
    }
